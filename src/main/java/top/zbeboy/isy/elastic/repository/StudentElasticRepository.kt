 ...
 **/
interface StudentElasticRepository : ElasticsearchRepository<StudentElastic, String> {
    /**
     * 通过账号查询
     *
     * @param username 账号
     * @return 学生
     */
    fun findByUsername(username: String): StudentElastic
     ...
     * @return 学生
     */
    fun findByCollegeIdAndRoleNameLike(collegeId: Int, roleName: String): List<StudentElastic>
}