 ...
 **/
open class GraduationPracticeUnifyVo {
    var graduationPracticeUnifyId: String? = null
    @NotNull
    ...
    @NotNull
    @Size(max = 200)
    var graduationPracticeUnifyName: String? = null
    @NotNull
    @Size(max = 500)
    var graduationPracticeUnifyAddress: String? = null
    @NotNull
    @Size(max = 10)
    var graduationPracticeUnifyContacts: String? = null
    @NotNull
    @Size(max = 20)
    var graduationPracticeUnifyTel: String? = null
    @NotNull
