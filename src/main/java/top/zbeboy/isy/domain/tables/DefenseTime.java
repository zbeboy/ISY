...
public class DefenseTime extends TableImpl<DefenseTimeRecord> {
    ...
    private static final long serialVersionUID = 1895161456;
     ...
     */
    public final TableField<DefenseTimeRecord, String> DEFENSE_ARRANGEMENT_ID = createField("defense_arrangement_id", org.jooq.impl.SQLDataType.VARCHAR.length(64).nullable(false), this, "");

    /**
     * Create a <code>isy.defense_time</code> table reference
     */
    public DefenseTime() {
        this("defense_time", null);
    }
    ...
    private DefenseTime(String alias, Table<DefenseTimeRecord> aliased) {
        this(alias, aliased, null);
    }

    private DefenseTime(String alias, Table<DefenseTimeRecord> aliased, Field<?>[] parameters) {
