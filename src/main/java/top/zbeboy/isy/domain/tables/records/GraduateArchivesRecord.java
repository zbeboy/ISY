...
public class GraduateArchivesRecord extends TableRecordImpl<GraduateArchivesRecord> implements Record4<String, Byte, String, String> {
    ...
    private static final long serialVersionUID = -2097764262;
     ...
     */
    @Override
    public GraduateArchivesRecord value2(Byte value) {
     ...
     */
    @Override
    public GraduateArchivesRecord value3(String value) {
     ...
     */
    @Override
    public GraduateArchivesRecord values(String value1, Byte value2, String value3, String value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
