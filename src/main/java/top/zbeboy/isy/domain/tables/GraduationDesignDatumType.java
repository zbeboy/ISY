...
public class GraduationDesignDatumType extends TableImpl<GraduationDesignDatumTypeRecord> {
    ...
    private static final long serialVersionUID = 1918828668;
     ...
     */
    public final TableField<GraduationDesignDatumTypeRecord, String> GRADUATION_DESIGN_DATUM_TYPE_NAME = createField("graduation_design_datum_type_name", org.jooq.impl.SQLDataType.VARCHAR.length(25).nullable(false), this, "");
