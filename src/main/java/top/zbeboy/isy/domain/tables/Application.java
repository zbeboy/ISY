...
public class Application extends TableImpl<ApplicationRecord> {
    ...
    private static final long serialVersionUID = -1049408137;
     ...
     */
    public final TableField<ApplicationRecord, String> APPLICATION_NAME = createField("application_name", org.jooq.impl.SQLDataType.VARCHAR.length(30).nullable(false), this, "");
     ...
     */
    public final TableField<ApplicationRecord, String> APPLICATION_URL = createField("application_url", org.jooq.impl.SQLDataType.VARCHAR.length(300).nullable(false), this, "");

    /**
     * The column <code>isy.application.application_code</code>.
     */
    public final TableField<ApplicationRecord, String> APPLICATION_CODE = createField("application_code", org.jooq.impl.SQLDataType.VARCHAR.length(100).nullable(false), this, "");

    /**
     * The column <code>isy.application.application_en_name</code>.
     */
    public final TableField<ApplicationRecord, String> APPLICATION_EN_NAME = createField("application_en_name", org.jooq.impl.SQLDataType.VARCHAR.length(100).nullable(false), this, "");

    /**
     * The column <code>isy.application.icon</code>.
     */
    public final TableField<ApplicationRecord, String> ICON = createField("icon", org.jooq.impl.SQLDataType.VARCHAR.length(20), this, "");
