...
public class Building extends TableImpl<BuildingRecord> {
    ...
    private static final long serialVersionUID = 1603681539;
     ...
     */
    public final TableField<BuildingRecord, Integer> BUILDING_ID = createField("building_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "");
