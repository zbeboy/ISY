...
public class GraduationDesignDeclareData extends TableImpl<GraduationDesignDeclareDataRecord> {
    ...
    private static final long serialVersionUID = -1681419428;
     ...
     */
    public final TableField<GraduationDesignDeclareDataRecord, String> GRADUATION_DESIGN_DECLARE_DATA_ID = createField("graduation_design_declare_data_id", org.jooq.impl.SQLDataType.VARCHAR.length(64).nullable(false), this, "");

    /**
     * The column <code>isy.graduation_design_declare_data.graduation_date</code>.
     */
    public final TableField<GraduationDesignDeclareDataRecord, String> GRADUATION_DATE = createField("graduation_date", org.jooq.impl.SQLDataType.VARCHAR.length(30), this, "");

    /**
     * The column <code>isy.graduation_design_declare_data.department_name</code>.
     */
    public final TableField<GraduationDesignDeclareDataRecord, String> DEPARTMENT_NAME = createField("department_name", org.jooq.impl.SQLDataType.VARCHAR.length(200), this, "");

    /**
     * The column <code>isy.graduation_design_declare_data.science_name</code>.
     */
    public final TableField<GraduationDesignDeclareDataRecord, String> SCIENCE_NAME = createField("science_name", org.jooq.impl.SQLDataType.VARCHAR.length(200), this, "");

    /**
     * The column <code>isy.graduation_design_declare_data.organize_names</code>.
     */
    public final TableField<GraduationDesignDeclareDataRecord, String> ORGANIZE_NAMES = createField("organize_names", org.jooq.impl.SQLDataType.VARCHAR.length(150), this, "");

    /**
     * The column <code>isy.graduation_design_declare_data.organize_peoples</code>.
     */
    public final TableField<GraduationDesignDeclareDataRecord, String> ORGANIZE_PEOPLES = createField("organize_peoples", org.jooq.impl.SQLDataType.VARCHAR.length(150), this, "");

    /**
     * The column <code>isy.graduation_design_declare_data.graduation_design_release_id</code>.
     */
    public final TableField<GraduationDesignDeclareDataRecord, String> GRADUATION_DESIGN_RELEASE_ID = createField("graduation_design_release_id", org.jooq.impl.SQLDataType.VARCHAR.length(64).nullable(false), this, "");

    /**
     * Create a <code>isy.graduation_design_declare_data</code> table reference
     */
    public GraduationDesignDeclareData() {
        this("graduation_design_declare_data", null);
    }
    ...
    private GraduationDesignDeclareData(String alias, Table<GraduationDesignDeclareDataRecord> aliased) {
        this(alias, aliased, null);
    }

    private GraduationDesignDeclareData(String alias, Table<GraduationDesignDeclareDataRecord> aliased, Field<?>[] parameters) {
