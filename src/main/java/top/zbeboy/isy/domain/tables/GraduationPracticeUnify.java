...
public class GraduationPracticeUnify extends TableImpl<GraduationPracticeUnifyRecord> {
    ...
    private static final long serialVersionUID = 1472433409;
     ...
     */
    public final TableField<GraduationPracticeUnifyRecord, String> GRADUATION_PRACTICE_UNIFY_ID = createField("graduation_practice_unify_id", org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");

    /**
     * The column <code>isy.graduation_practice_unify.student_name</code>.
     */
    public final TableField<GraduationPracticeUnifyRecord, String> STUDENT_NAME = createField("student_name", org.jooq.impl.SQLDataType.VARCHAR(15).nullable(false), this, "");

    /**
     * The column <code>isy.graduation_practice_unify.college_class</code>.
     */
    public final TableField<GraduationPracticeUnifyRecord, String> COLLEGE_CLASS = createField("college_class", org.jooq.impl.SQLDataType.VARCHAR(50).nullable(false), this, "");

    /**
     * The column <code>isy.graduation_practice_unify.student_sex</code>.
     */
    public final TableField<GraduationPracticeUnifyRecord, String> STUDENT_SEX = createField("student_sex", org.jooq.impl.SQLDataType.VARCHAR(20).nullable(false), this, "");

    /**
     * The column <code>isy.graduation_practice_unify.student_number</code>.
     */
    public final TableField<GraduationPracticeUnifyRecord, String> STUDENT_NUMBER = createField("student_number", org.jooq.impl.SQLDataType.VARCHAR(20).nullable(false), this, "");

    /**
     * The column <code>isy.graduation_practice_unify.phone_number</code>.
     */
    public final TableField<GraduationPracticeUnifyRecord, String> PHONE_NUMBER = createField("phone_number", org.jooq.impl.SQLDataType.VARCHAR(15).nullable(false), this, "");

    /**
     * The column <code>isy.graduation_practice_unify.qq_mailbox</code>.
     */
    public final TableField<GraduationPracticeUnifyRecord, String> QQ_MAILBOX = createField("qq_mailbox", org.jooq.impl.SQLDataType.VARCHAR(100).nullable(false), this, "");

    /**
     * The column <code>isy.graduation_practice_unify.parental_contact</code>.
     */
    public final TableField<GraduationPracticeUnifyRecord, String> PARENTAL_CONTACT = createField("parental_contact", org.jooq.impl.SQLDataType.VARCHAR(48).nullable(false), this, "");

    /**
     * The column <code>isy.graduation_practice_unify.headmaster</code>.
     */
    public final TableField<GraduationPracticeUnifyRecord, String> HEADMASTER = createField("headmaster", org.jooq.impl.SQLDataType.VARCHAR(10).nullable(false), this, "");

    /**
     * The column <code>isy.graduation_practice_unify.headmaster_contact</code>.
     */
    public final TableField<GraduationPracticeUnifyRecord, String> HEADMASTER_CONTACT = createField("headmaster_contact", org.jooq.impl.SQLDataType.VARCHAR(20).nullable(false), this, "");

    /**
     * The column <code>isy.graduation_practice_unify.graduation_practice_unify_name</code>.
     */
    public final TableField<GraduationPracticeUnifyRecord, String> GRADUATION_PRACTICE_UNIFY_NAME = createField("graduation_practice_unify_name", org.jooq.impl.SQLDataType.VARCHAR(200).nullable(false), this, "");

    /**
     * The column <code>isy.graduation_practice_unify.graduation_practice_unify_address</code>.
     */
    public final TableField<GraduationPracticeUnifyRecord, String> GRADUATION_PRACTICE_UNIFY_ADDRESS = createField("graduation_practice_unify_address", org.jooq.impl.SQLDataType.VARCHAR(500).nullable(false), this, "");

    /**
     * The column <code>isy.graduation_practice_unify.graduation_practice_unify_contacts</code>.
     */
    public final TableField<GraduationPracticeUnifyRecord, String> GRADUATION_PRACTICE_UNIFY_CONTACTS = createField("graduation_practice_unify_contacts", org.jooq.impl.SQLDataType.VARCHAR(10).nullable(false), this, "");

    /**
     * The column <code>isy.graduation_practice_unify.graduation_practice_unify_tel</code>.
     */
    public final TableField<GraduationPracticeUnifyRecord, String> GRADUATION_PRACTICE_UNIFY_TEL = createField("graduation_practice_unify_tel", org.jooq.impl.SQLDataType.VARCHAR(20).nullable(false), this, "");

    /**
     * The column <code>isy.graduation_practice_unify.school_guidance_teacher</code>.
     */
    public final TableField<GraduationPracticeUnifyRecord, String> SCHOOL_GUIDANCE_TEACHER = createField("school_guidance_teacher", org.jooq.impl.SQLDataType.VARCHAR(10).nullable(false), this, "");

    /**
     * The column <code>isy.graduation_practice_unify.school_guidance_teacher_tel</code>.
     */
    public final TableField<GraduationPracticeUnifyRecord, String> SCHOOL_GUIDANCE_TEACHER_TEL = createField("school_guidance_teacher_tel", org.jooq.impl.SQLDataType.VARCHAR(20).nullable(false), this, "");
     ...
     */
    public final TableField<GraduationPracticeUnifyRecord, String> STUDENT_USERNAME = createField("student_username", org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");

    /**
     * The column <code>isy.graduation_practice_unify.internship_release_id</code>.
     */
    public final TableField<GraduationPracticeUnifyRecord, String> INTERNSHIP_RELEASE_ID = createField("internship_release_id", org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");
