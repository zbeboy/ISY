...
public class DefenseArrangementRecord extends UpdatableRecordImpl<DefenseArrangementRecord> implements Record10<String, Date, Date, Date, Date, String, String, Integer, String, String> {

    private static final long serialVersionUID = 648805090;
     ...
     */
    @Override
    public Row10<String, Date, Date, Date, Date, String, String, Integer, String, String> fieldsRow() {
     ...
     */
    @Override
    public Row10<String, Date, Date, Date, Date, String, String, Integer, String, String> valuesRow() {
     ...
     */
    @Override
    public DefenseArrangementRecord value8(Integer value) {
     ...
     */
    @Override
    public DefenseArrangementRecord value10(String value) {
     ...
     */
    @Override
    public DefenseArrangementRecord values(String value1, Date value2, Date value3, Date value4, Date value5, String value6, String value7, Integer value8, String value9, String value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public DefenseArrangementRecord(String defenseArrangementId, Date paperStartDate, Date paperEndDate, Date defenseStartDate, Date defenseEndDate, String defenseStartTime, String defenseEndTime, Integer intervalTime, String defenseNote, String graduationDesignReleaseId) {
        super(DefenseArrangement.DEFENSE_ARRANGEMENT);
        ...
        set(7, intervalTime);
        set(8, defenseNote);
        set(9, graduationDesignReleaseId);
    }
}
