...
public class DefenseArrangementRecord extends UpdatableRecordImpl<DefenseArrangementRecord> implements Record9<String, Timestamp, Timestamp, Date, Date, String, String, String, String> {

    private static final long serialVersionUID = -1538213790;
     ...
     */
    @Override
    public Row9<String, Timestamp, Timestamp, Date, Date, String, String, String, String> fieldsRow() {
     ...
     */
    @Override
    public Row9<String, Timestamp, Timestamp, Date, Date, String, String, String, String> valuesRow() {
     ...
     */
    @Override
    public DefenseArrangementRecord values(String value1, Timestamp value2, Timestamp value3, Date value4, Date value5, String value6, String value7, String value8, String value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public DefenseArrangementRecord(String defenseArrangementId, Timestamp paperStartTime, Timestamp paperEndTime, Date defenseStartDate, Date defenseEndDate, String defenseStartTime, String defenseEndTime, String defenseNote, String graduationDesignReleaseId) {
        super(DefenseArrangement.DEFENSE_ARRANGEMENT);
