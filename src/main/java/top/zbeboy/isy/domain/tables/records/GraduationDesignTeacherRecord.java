...
public class GraduationDesignTeacherRecord extends UpdatableRecordImpl<GraduationDesignTeacherRecord> implements Record7<String, String, Integer, Integer, Integer, String, String> {

    private static final long serialVersionUID = -983467394;
     ...
     */
    @Override
    public Row7<String, String, Integer, Integer, Integer, String, String> fieldsRow() {
     ...
     */
    @Override
    public Row7<String, String, Integer, Integer, Integer, String, String> valuesRow() {
     ...
     */
    @Override
    public GraduationDesignTeacherRecord values(String value1, String value2, Integer value3, Integer value4, Integer value5, String value6, String value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public GraduationDesignTeacherRecord(String graduationDesignTeacherId, String graduationDesignReleaseId, Integer staffId, Integer studentCount, Integer residue, String username, String assignerName) {
        super(GraduationDesignTeacher.GRADUATION_DESIGN_TEACHER);
