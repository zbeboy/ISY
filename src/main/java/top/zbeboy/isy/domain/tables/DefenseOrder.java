...
public class DefenseOrder extends TableImpl<DefenseOrderRecord> {
    ...
    private static final long serialVersionUID = -339098177;
    ...
    /**
     * The column <code>isy.defense_order.staff_id</code>.
     */
    public final TableField<DefenseOrderRecord, Integer> STAFF_ID = createField("staff_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
    ...
    public List<ForeignKey<DefenseOrderRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<DefenseOrderRecord, ?>>asList(Keys.DEFENSE_ORDER_IBFK_1, Keys.DEFENSE_ORDER_IBFK_2, Keys.DEFENSE_ORDER_IBFK_3);
    }
