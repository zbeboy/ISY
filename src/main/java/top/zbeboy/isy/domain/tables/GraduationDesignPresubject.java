...
public class GraduationDesignPresubject extends TableImpl<GraduationDesignPresubjectRecord> {
    ...
    private static final long serialVersionUID = -2042970422;
     ...
     */
    public final TableField<GraduationDesignPresubjectRecord, String> GRADUATION_DESIGN_PRESUBJECT_ID = createField("graduation_design_presubject_id", org.jooq.impl.SQLDataType.VARCHAR.length(64).nullable(false), this, "");

    /**
     * The column <code>isy.graduation_design_presubject.presubject_title</code>.
     */
    public final TableField<GraduationDesignPresubjectRecord, String> PRESUBJECT_TITLE = createField("presubject_title", org.jooq.impl.SQLDataType.VARCHAR.length(100).nullable(false), this, "");
     ...
     */
    public final TableField<GraduationDesignPresubjectRecord, String> GRADUATION_DESIGN_RELEASE_ID = createField("graduation_design_release_id", org.jooq.impl.SQLDataType.VARCHAR.length(64).nullable(false), this, "");
    ...
    public GraduationDesignPresubject() {
        this("graduation_design_presubject", null);
    }
    ...
    private GraduationDesignPresubject(String alias, Table<GraduationDesignPresubjectRecord> aliased) {
        this(alias, aliased, null);
    }

    private GraduationDesignPresubject(String alias, Table<GraduationDesignPresubjectRecord> aliased, Field<?>[] parameters) {
