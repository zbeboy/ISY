...
public class Science extends TableImpl<ScienceRecord> {
    ...
    private static final long serialVersionUID = -1941136898;
     ...
     */
    public final TableField<ScienceRecord, Integer> SCIENCE_ID = createField("science_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
    ...
    private Science(String alias, Table<ScienceRecord> aliased) {
        this(alias, aliased, null);
    }

    private Science(String alias, Table<ScienceRecord> aliased, Field<?>[] parameters) {
