...
public class ScoreType extends TableImpl<ScoreTypeRecord> {
    ...
    private static final long serialVersionUID = 2051672807;
     ...
     */
    public final TableField<ScoreTypeRecord, Integer> SCORE_TYPE_ID = createField("score_type_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "");

    /**
     * The column <code>isy.score_type.score_type_name</code>.
     */
    public final TableField<ScoreTypeRecord, String> SCORE_TYPE_NAME = createField("score_type_name", org.jooq.impl.SQLDataType.VARCHAR(20).nullable(false), this, "");

    /**
     * Create a <code>isy.score_type</code> table reference
     */
    public ScoreType() {
        this(DSL.name("score_type"), null);
    }
    ...
    public ScoreType(String alias) {
        this(DSL.name(alias), SCORE_TYPE);
    }

    /**
     * Create an aliased <code>isy.score_type</code> table reference
     */
    public ScoreType(Name alias) {
        this(alias, SCORE_TYPE);
    }

    private ScoreType(Name alias, Table<ScoreTypeRecord> aliased) {
        this(alias, aliased, null);
    }

    private ScoreType(Name alias, Table<ScoreTypeRecord> aliased, Field<?>[] parameters) {
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.SCORE_TYPE_PRIMARY);
    }
    ...
    public ScoreType as(String alias) {
        return new ScoreType(DSL.name(alias), this);
    }
     ...
     */
    @Override
    public ScoreType as(Name alias) {
    ...
    public ScoreType rename(String name) {
        return new ScoreType(DSL.name(name), null);
    }
     ...
     */
    @Override
    public ScoreType rename(Name name) {
