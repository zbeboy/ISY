...
public class RoleApplicationRecord extends UpdatableRecordImpl<RoleApplicationRecord> implements Record2<Integer, String> {

    private static final long serialVersionUID = 329489929;
     ...
     */
    @Override
    public RoleApplicationRecord values(Integer value1, String value2) {
        value1(value1);
        value2(value2);
        return this;
    }
     ...
     */
    public RoleApplicationRecord(Integer roleId, String applicationId) {
        super(RoleApplication.ROLE_APPLICATION);
