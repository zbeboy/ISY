...
public class GraduationPracticeCompany extends TableImpl<GraduationPracticeCompanyRecord> {
    ...
    private static final long serialVersionUID = -1092311051;
     ...
     */
    public final TableField<GraduationPracticeCompanyRecord, String> GRADUATION_PRACTICE_COMPANY_ID = createField("graduation_practice_company_id", org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");

    /**
     * The column <code>isy.graduation_practice_company.student_name</code>.
     */
    public final TableField<GraduationPracticeCompanyRecord, String> STUDENT_NAME = createField("student_name", org.jooq.impl.SQLDataType.VARCHAR(15).nullable(false), this, "");

    /**
     * The column <code>isy.graduation_practice_company.college_class</code>.
     */
    public final TableField<GraduationPracticeCompanyRecord, String> COLLEGE_CLASS = createField("college_class", org.jooq.impl.SQLDataType.VARCHAR(50).nullable(false), this, "");

    /**
     * The column <code>isy.graduation_practice_company.student_sex</code>.
     */
    public final TableField<GraduationPracticeCompanyRecord, String> STUDENT_SEX = createField("student_sex", org.jooq.impl.SQLDataType.VARCHAR(20).nullable(false), this, "");

    /**
     * The column <code>isy.graduation_practice_company.student_number</code>.
     */
    public final TableField<GraduationPracticeCompanyRecord, String> STUDENT_NUMBER = createField("student_number", org.jooq.impl.SQLDataType.VARCHAR(20).nullable(false), this, "");

    /**
     * The column <code>isy.graduation_practice_company.phone_number</code>.
     */
    public final TableField<GraduationPracticeCompanyRecord, String> PHONE_NUMBER = createField("phone_number", org.jooq.impl.SQLDataType.VARCHAR(15).nullable(false), this, "");

    /**
     * The column <code>isy.graduation_practice_company.qq_mailbox</code>.
     */
    public final TableField<GraduationPracticeCompanyRecord, String> QQ_MAILBOX = createField("qq_mailbox", org.jooq.impl.SQLDataType.VARCHAR(100).nullable(false), this, "");

    /**
     * The column <code>isy.graduation_practice_company.parental_contact</code>.
     */
    public final TableField<GraduationPracticeCompanyRecord, String> PARENTAL_CONTACT = createField("parental_contact", org.jooq.impl.SQLDataType.VARCHAR(48).nullable(false), this, "");

    /**
     * The column <code>isy.graduation_practice_company.headmaster</code>.
     */
    public final TableField<GraduationPracticeCompanyRecord, String> HEADMASTER = createField("headmaster", org.jooq.impl.SQLDataType.VARCHAR(10).nullable(false), this, "");

    /**
     * The column <code>isy.graduation_practice_company.headmaster_contact</code>.
     */
    public final TableField<GraduationPracticeCompanyRecord, String> HEADMASTER_CONTACT = createField("headmaster_contact", org.jooq.impl.SQLDataType.VARCHAR(20).nullable(false), this, "");

    /**
     * The column <code>isy.graduation_practice_company.graduation_practice_company_name</code>.
     */
    public final TableField<GraduationPracticeCompanyRecord, String> GRADUATION_PRACTICE_COMPANY_NAME = createField("graduation_practice_company_name", org.jooq.impl.SQLDataType.VARCHAR(200).nullable(false), this, "");

    /**
     * The column <code>isy.graduation_practice_company.graduation_practice_company_address</code>.
     */
    public final TableField<GraduationPracticeCompanyRecord, String> GRADUATION_PRACTICE_COMPANY_ADDRESS = createField("graduation_practice_company_address", org.jooq.impl.SQLDataType.VARCHAR(500).nullable(false), this, "");

    /**
     * The column <code>isy.graduation_practice_company.graduation_practice_company_contacts</code>.
     */
    public final TableField<GraduationPracticeCompanyRecord, String> GRADUATION_PRACTICE_COMPANY_CONTACTS = createField("graduation_practice_company_contacts", org.jooq.impl.SQLDataType.VARCHAR(10).nullable(false), this, "");

    /**
     * The column <code>isy.graduation_practice_company.graduation_practice_company_tel</code>.
     */
    public final TableField<GraduationPracticeCompanyRecord, String> GRADUATION_PRACTICE_COMPANY_TEL = createField("graduation_practice_company_tel", org.jooq.impl.SQLDataType.VARCHAR(20).nullable(false), this, "");

    /**
     * The column <code>isy.graduation_practice_company.school_guidance_teacher</code>.
     */
    public final TableField<GraduationPracticeCompanyRecord, String> SCHOOL_GUIDANCE_TEACHER = createField("school_guidance_teacher", org.jooq.impl.SQLDataType.VARCHAR(10).nullable(false), this, "");

    /**
     * The column <code>isy.graduation_practice_company.school_guidance_teacher_tel</code>.
     */
    public final TableField<GraduationPracticeCompanyRecord, String> SCHOOL_GUIDANCE_TEACHER_TEL = createField("school_guidance_teacher_tel", org.jooq.impl.SQLDataType.VARCHAR(20).nullable(false), this, "");
     ...
     */
    public final TableField<GraduationPracticeCompanyRecord, String> STUDENT_USERNAME = createField("student_username", org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");

    /**
     * The column <code>isy.graduation_practice_company.internship_release_id</code>.
     */
    public final TableField<GraduationPracticeCompanyRecord, String> INTERNSHIP_RELEASE_ID = createField("internship_release_id", org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");
