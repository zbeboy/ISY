...
public class OauthClientDetails extends TableImpl<OauthClientDetailsRecord> {
    ...
    private static final long serialVersionUID = -1996977627;
     ...
     */
    public final TableField<OauthClientDetailsRecord, String> CLIENT_ID = createField("client_id", org.jooq.impl.SQLDataType.VARCHAR.length(256).nullable(false), this, "");

    /**
     * The column <code>isy.oauth_client_details.resource_ids</code>.
     */
    public final TableField<OauthClientDetailsRecord, String> RESOURCE_IDS = createField("resource_ids", org.jooq.impl.SQLDataType.VARCHAR.length(256), this, "");

    /**
     * The column <code>isy.oauth_client_details.client_secret</code>.
     */
    public final TableField<OauthClientDetailsRecord, String> CLIENT_SECRET = createField("client_secret", org.jooq.impl.SQLDataType.VARCHAR.length(256), this, "");

    /**
     * The column <code>isy.oauth_client_details.scope</code>.
     */
    public final TableField<OauthClientDetailsRecord, String> SCOPE = createField("scope", org.jooq.impl.SQLDataType.VARCHAR.length(256), this, "");

    /**
     * The column <code>isy.oauth_client_details.authorized_grant_types</code>.
     */
    public final TableField<OauthClientDetailsRecord, String> AUTHORIZED_GRANT_TYPES = createField("authorized_grant_types", org.jooq.impl.SQLDataType.VARCHAR.length(256), this, "");

    /**
     * The column <code>isy.oauth_client_details.web_server_redirect_uri</code>.
     */
    public final TableField<OauthClientDetailsRecord, String> WEB_SERVER_REDIRECT_URI = createField("web_server_redirect_uri", org.jooq.impl.SQLDataType.VARCHAR.length(256), this, "");

    /**
     * The column <code>isy.oauth_client_details.authorities</code>.
     */
    public final TableField<OauthClientDetailsRecord, String> AUTHORITIES = createField("authorities", org.jooq.impl.SQLDataType.VARCHAR.length(256), this, "");
     ...
     */
    public final TableField<OauthClientDetailsRecord, String> AUTOAPPROVE = createField("autoapprove", org.jooq.impl.SQLDataType.VARCHAR.length(256), this, "");
