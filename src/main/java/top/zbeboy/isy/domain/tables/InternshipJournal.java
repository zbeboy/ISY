...
public class InternshipJournal extends TableImpl<InternshipJournalRecord> {
    ...
    private static final long serialVersionUID = -1650883906;
     ...
     */
    public final TableField<InternshipJournalRecord, String> STUDENT_NAME = createField("student_name", org.jooq.impl.SQLDataType.VARCHAR.length(30).nullable(false), this, "");
     ...
     */
    public final TableField<InternshipJournalRecord, String> ORGANIZE = createField("organize", org.jooq.impl.SQLDataType.VARCHAR.length(200).nullable(false), this, "");

    /**
     * The column <code>isy.internship_journal.school_guidance_teacher</code>.
     */
    public final TableField<InternshipJournalRecord, String> SCHOOL_GUIDANCE_TEACHER = createField("school_guidance_teacher", org.jooq.impl.SQLDataType.VARCHAR.length(30).nullable(false), this, "");
