...
public class InternshipTeacherDistributionRecord extends TableRecordImpl<InternshipTeacherDistributionRecord> implements Record4<Integer, Integer, String, String> {

	private static final long serialVersionUID = -783692249;
