...
public class UsersKey extends TableImpl<UsersKeyRecord> {
    ...
    private static final long serialVersionUID = 1623173534;
     ...
     */
    public final TableField<UsersKeyRecord, String> USERNAME = createField("username", org.jooq.impl.SQLDataType.VARCHAR.length(64).nullable(false), this, "");

    /**
     * The column <code>isy.users_key.user_key</code>.
     */
    public final TableField<UsersKeyRecord, String> USER_KEY = createField("user_key", org.jooq.impl.SQLDataType.VARCHAR.length(64).nullable(false), this, "");
    ...
    private UsersKey(String alias, Table<UsersKeyRecord> aliased) {
        this(alias, aliased, null);
    }

    private UsersKey(String alias, Table<UsersKeyRecord> aliased, Field<?>[] parameters) {
