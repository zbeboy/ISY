...
public class InternshipTeacherDistributionDao extends DAOImpl<InternshipTeacherDistributionRecord, top.zbeboy.isy.domain.tables.pojos.InternshipTeacherDistribution, String> {
	 ...
	 */
	@Override
	protected String getId(top.zbeboy.isy.domain.tables.pojos.InternshipTeacherDistribution object) {
		return object.getInternshipTeacherDistributionId();
	}

	/**
	 * Fetch records that have <code>internship_teacher_distribution_id IN (values)</code>
	 */
	public List<top.zbeboy.isy.domain.tables.pojos.InternshipTeacherDistribution> fetchByInternshipTeacherDistributionId(String... values) {
		return fetch(InternshipTeacherDistribution.INTERNSHIP_TEACHER_DISTRIBUTION.INTERNSHIP_TEACHER_DISTRIBUTION_ID, values);
	}

	/**
	 * Fetch a unique record that has <code>internship_teacher_distribution_id = value</code>
	 */
	public top.zbeboy.isy.domain.tables.pojos.InternshipTeacherDistribution fetchOneByInternshipTeacherDistributionId(String value) {
		return fetchOne(InternshipTeacherDistribution.INTERNSHIP_TEACHER_DISTRIBUTION.INTERNSHIP_TEACHER_DISTRIBUTION_ID, value);
	}
