...
public class InternshipCompany extends TableImpl<InternshipCompanyRecord> {
    ...
    private static final long serialVersionUID = -1033190900;
     ...
     */
    public final TableField<InternshipCompanyRecord, String> INTERNSHIP_COMPANY_ID = createField("internship_company_id", org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");

    /**
     * The column <code>isy.internship_company.student_name</code>.
     */
    public final TableField<InternshipCompanyRecord, String> STUDENT_NAME = createField("student_name", org.jooq.impl.SQLDataType.VARCHAR(15).nullable(false), this, "");

    /**
     * The column <code>isy.internship_company.college_class</code>.
     */
    public final TableField<InternshipCompanyRecord, String> COLLEGE_CLASS = createField("college_class", org.jooq.impl.SQLDataType.VARCHAR(50).nullable(false), this, "");

    /**
     * The column <code>isy.internship_company.student_sex</code>.
     */
    public final TableField<InternshipCompanyRecord, String> STUDENT_SEX = createField("student_sex", org.jooq.impl.SQLDataType.VARCHAR(20).nullable(false), this, "");

    /**
     * The column <code>isy.internship_company.student_number</code>.
     */
    public final TableField<InternshipCompanyRecord, String> STUDENT_NUMBER = createField("student_number", org.jooq.impl.SQLDataType.VARCHAR(20).nullable(false), this, "");

    /**
     * The column <code>isy.internship_company.phone_number</code>.
     */
    public final TableField<InternshipCompanyRecord, String> PHONE_NUMBER = createField("phone_number", org.jooq.impl.SQLDataType.VARCHAR(15).nullable(false), this, "");

    /**
     * The column <code>isy.internship_company.qq_mailbox</code>.
     */
    public final TableField<InternshipCompanyRecord, String> QQ_MAILBOX = createField("qq_mailbox", org.jooq.impl.SQLDataType.VARCHAR(100).nullable(false), this, "");

    /**
     * The column <code>isy.internship_company.parental_contact</code>.
     */
    public final TableField<InternshipCompanyRecord, String> PARENTAL_CONTACT = createField("parental_contact", org.jooq.impl.SQLDataType.VARCHAR(48).nullable(false), this, "");

    /**
     * The column <code>isy.internship_company.headmaster</code>.
     */
    public final TableField<InternshipCompanyRecord, String> HEADMASTER = createField("headmaster", org.jooq.impl.SQLDataType.VARCHAR(10).nullable(false), this, "");

    /**
     * The column <code>isy.internship_company.headmaster_contact</code>.
     */
    public final TableField<InternshipCompanyRecord, String> HEADMASTER_CONTACT = createField("headmaster_contact", org.jooq.impl.SQLDataType.VARCHAR(20).nullable(false), this, "");

    /**
     * The column <code>isy.internship_company.internship_company_name</code>.
     */
    public final TableField<InternshipCompanyRecord, String> INTERNSHIP_COMPANY_NAME = createField("internship_company_name", org.jooq.impl.SQLDataType.VARCHAR(200).nullable(false), this, "");

    /**
     * The column <code>isy.internship_company.internship_company_address</code>.
     */
    public final TableField<InternshipCompanyRecord, String> INTERNSHIP_COMPANY_ADDRESS = createField("internship_company_address", org.jooq.impl.SQLDataType.VARCHAR(500).nullable(false), this, "");

    /**
     * The column <code>isy.internship_company.internship_company_contacts</code>.
     */
    public final TableField<InternshipCompanyRecord, String> INTERNSHIP_COMPANY_CONTACTS = createField("internship_company_contacts", org.jooq.impl.SQLDataType.VARCHAR(10).nullable(false), this, "");

    /**
     * The column <code>isy.internship_company.internship_company_tel</code>.
     */
    public final TableField<InternshipCompanyRecord, String> INTERNSHIP_COMPANY_TEL = createField("internship_company_tel", org.jooq.impl.SQLDataType.VARCHAR(20).nullable(false), this, "");

    /**
     * The column <code>isy.internship_company.school_guidance_teacher</code>.
     */
    public final TableField<InternshipCompanyRecord, String> SCHOOL_GUIDANCE_TEACHER = createField("school_guidance_teacher", org.jooq.impl.SQLDataType.VARCHAR(10).nullable(false), this, "");

    /**
     * The column <code>isy.internship_company.school_guidance_teacher_tel</code>.
     */
    public final TableField<InternshipCompanyRecord, String> SCHOOL_GUIDANCE_TEACHER_TEL = createField("school_guidance_teacher_tel", org.jooq.impl.SQLDataType.VARCHAR(20).nullable(false), this, "");
     ...
     */
    public final TableField<InternshipCompanyRecord, String> STUDENT_USERNAME = createField("student_username", org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");

    /**
     * The column <code>isy.internship_company.internship_release_id</code>.
     */
    public final TableField<InternshipCompanyRecord, String> INTERNSHIP_RELEASE_ID = createField("internship_release_id", org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");
