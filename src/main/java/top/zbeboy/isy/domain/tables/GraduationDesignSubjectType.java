...
public class GraduationDesignSubjectType extends TableImpl<GraduationDesignSubjectTypeRecord> {
    ...
    private static final long serialVersionUID = 1721747735;
     ...
     */
    public final TableField<GraduationDesignSubjectTypeRecord, Integer> SUBJECT_TYPE_ID = createField("subject_type_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "");

    /**
     * The column <code>isy.graduation_design_subject_type.subject_type_name</code>.
     */
    public final TableField<GraduationDesignSubjectTypeRecord, String> SUBJECT_TYPE_NAME = createField("subject_type_name", org.jooq.impl.SQLDataType.VARCHAR(30).nullable(false), this, "");

    /**
     * Create a <code>isy.graduation_design_subject_type</code> table reference
     */
    public GraduationDesignSubjectType() {
        this(DSL.name("graduation_design_subject_type"), null);
    }
    ...
    public GraduationDesignSubjectType(String alias) {
        this(DSL.name(alias), GRADUATION_DESIGN_SUBJECT_TYPE);
    }

    /**
     * Create an aliased <code>isy.graduation_design_subject_type</code> table reference
     */
    public GraduationDesignSubjectType(Name alias) {
        this(alias, GRADUATION_DESIGN_SUBJECT_TYPE);
    }

    private GraduationDesignSubjectType(Name alias, Table<GraduationDesignSubjectTypeRecord> aliased) {
        this(alias, aliased, null);
    }

    private GraduationDesignSubjectType(Name alias, Table<GraduationDesignSubjectTypeRecord> aliased, Field<?>[] parameters) {
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.GRADUATION_DESIGN_SUBJECT_TYPE_PRIMARY);
    }
    ...
    public GraduationDesignSubjectType as(String alias) {
        return new GraduationDesignSubjectType(DSL.name(alias), this);
    }
     ...
     */
    @Override
    public GraduationDesignSubjectType as(Name alias) {
    ...
    public GraduationDesignSubjectType rename(String name) {
        return new GraduationDesignSubjectType(DSL.name(name), null);
    }
     ...
     */
    @Override
    public GraduationDesignSubjectType rename(Name name) {
