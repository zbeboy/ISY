...
public class GraduationPracticeCollege extends TableImpl<GraduationPracticeCollegeRecord> {
    ...
    private static final long serialVersionUID = 1593176807;
     ...
     */
    public final TableField<GraduationPracticeCollegeRecord, String> GRADUATION_PRACTICE_COLLEGE_ID = createField("graduation_practice_college_id", org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");

    /**
     * The column <code>isy.graduation_practice_college.student_name</code>.
     */
    public final TableField<GraduationPracticeCollegeRecord, String> STUDENT_NAME = createField("student_name", org.jooq.impl.SQLDataType.VARCHAR(15).nullable(false), this, "");

    /**
     * The column <code>isy.graduation_practice_college.college_class</code>.
     */
    public final TableField<GraduationPracticeCollegeRecord, String> COLLEGE_CLASS = createField("college_class", org.jooq.impl.SQLDataType.VARCHAR(50).nullable(false), this, "");

    /**
     * The column <code>isy.graduation_practice_college.student_sex</code>.
     */
    public final TableField<GraduationPracticeCollegeRecord, String> STUDENT_SEX = createField("student_sex", org.jooq.impl.SQLDataType.VARCHAR(20).nullable(false), this, "");

    /**
     * The column <code>isy.graduation_practice_college.student_number</code>.
     */
    public final TableField<GraduationPracticeCollegeRecord, String> STUDENT_NUMBER = createField("student_number", org.jooq.impl.SQLDataType.VARCHAR(20).nullable(false), this, "");

    /**
     * The column <code>isy.graduation_practice_college.phone_number</code>.
     */
    public final TableField<GraduationPracticeCollegeRecord, String> PHONE_NUMBER = createField("phone_number", org.jooq.impl.SQLDataType.VARCHAR(15).nullable(false), this, "");

    /**
     * The column <code>isy.graduation_practice_college.qq_mailbox</code>.
     */
    public final TableField<GraduationPracticeCollegeRecord, String> QQ_MAILBOX = createField("qq_mailbox", org.jooq.impl.SQLDataType.VARCHAR(100).nullable(false), this, "");

    /**
     * The column <code>isy.graduation_practice_college.parental_contact</code>.
     */
    public final TableField<GraduationPracticeCollegeRecord, String> PARENTAL_CONTACT = createField("parental_contact", org.jooq.impl.SQLDataType.VARCHAR(48).nullable(false), this, "");

    /**
     * The column <code>isy.graduation_practice_college.headmaster</code>.
     */
    public final TableField<GraduationPracticeCollegeRecord, String> HEADMASTER = createField("headmaster", org.jooq.impl.SQLDataType.VARCHAR(10).nullable(false), this, "");

    /**
     * The column <code>isy.graduation_practice_college.headmaster_contact</code>.
     */
    public final TableField<GraduationPracticeCollegeRecord, String> HEADMASTER_CONTACT = createField("headmaster_contact", org.jooq.impl.SQLDataType.VARCHAR(20).nullable(false), this, "");

    /**
     * The column <code>isy.graduation_practice_college.graduation_practice_college_name</code>.
     */
    public final TableField<GraduationPracticeCollegeRecord, String> GRADUATION_PRACTICE_COLLEGE_NAME = createField("graduation_practice_college_name", org.jooq.impl.SQLDataType.VARCHAR(200).nullable(false), this, "");

    /**
     * The column <code>isy.graduation_practice_college.graduation_practice_college_address</code>.
     */
    public final TableField<GraduationPracticeCollegeRecord, String> GRADUATION_PRACTICE_COLLEGE_ADDRESS = createField("graduation_practice_college_address", org.jooq.impl.SQLDataType.VARCHAR(500).nullable(false), this, "");

    /**
     * The column <code>isy.graduation_practice_college.graduation_practice_college_contacts</code>.
     */
    public final TableField<GraduationPracticeCollegeRecord, String> GRADUATION_PRACTICE_COLLEGE_CONTACTS = createField("graduation_practice_college_contacts", org.jooq.impl.SQLDataType.VARCHAR(10).nullable(false), this, "");

    /**
     * The column <code>isy.graduation_practice_college.graduation_practice_college_tel</code>.
     */
    public final TableField<GraduationPracticeCollegeRecord, String> GRADUATION_PRACTICE_COLLEGE_TEL = createField("graduation_practice_college_tel", org.jooq.impl.SQLDataType.VARCHAR(20).nullable(false), this, "");

    /**
     * The column <code>isy.graduation_practice_college.school_guidance_teacher</code>.
     */
    public final TableField<GraduationPracticeCollegeRecord, String> SCHOOL_GUIDANCE_TEACHER = createField("school_guidance_teacher", org.jooq.impl.SQLDataType.VARCHAR(10).nullable(false), this, "");

    /**
     * The column <code>isy.graduation_practice_college.school_guidance_teacher_tel</code>.
     */
    public final TableField<GraduationPracticeCollegeRecord, String> SCHOOL_GUIDANCE_TEACHER_TEL = createField("school_guidance_teacher_tel", org.jooq.impl.SQLDataType.VARCHAR(20).nullable(false), this, "");
     ...
     */
    public final TableField<GraduationPracticeCollegeRecord, String> STUDENT_USERNAME = createField("student_username", org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");

    /**
     * The column <code>isy.graduation_practice_college.internship_release_id</code>.
     */
    public final TableField<GraduationPracticeCollegeRecord, String> INTERNSHIP_RELEASE_ID = createField("internship_release_id", org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");
