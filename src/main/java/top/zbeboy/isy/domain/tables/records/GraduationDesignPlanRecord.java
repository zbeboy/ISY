...
public class GraduationDesignPlanRecord extends UpdatableRecordImpl<GraduationDesignPlanRecord> implements Record8<String, String, String, String, String, String, Timestamp, Integer> {

    private static final long serialVersionUID = -491388923;
     ...
     */
    @Override
    public Row8<String, String, String, String, String, String, Timestamp, Integer> fieldsRow() {
     ...
     */
    @Override
    public Row8<String, String, String, String, String, String, Timestamp, Integer> valuesRow() {
     ...
     */
    @Override
    public GraduationDesignPlanRecord value7(Timestamp value) {
        setAddTime(value);
        return this;
    }
     ...
     */
    @Override
    public GraduationDesignPlanRecord values(String value1, String value2, String value3, String value4, String value5, String value6, Timestamp value7, Integer value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public GraduationDesignPlanRecord(String graduationDesignPlanId, String scheduling, String supervisionTime, String guideContent, String note, String graduationDesignTeacherId, Timestamp addTime, Integer schoolroomId) {
        super(GraduationDesignPlan.GRADUATION_DESIGN_PLAN);
        ...
        set(3, guideContent);
        set(4, note);
        set(5, graduationDesignTeacherId);
        set(6, addTime);
        set(7, schoolroomId);
    }
}
