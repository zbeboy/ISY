...
public class Users extends TableImpl<UsersRecord> {
    ...
    private static final long serialVersionUID = 1777090699;
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.USERS_MOBILE, Indexes.USERS_PRIMARY, Indexes.USERS_USERS_TYPE_ID);
    }
