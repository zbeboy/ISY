...
public class GraduationDesignDatumRecord extends TableRecordImpl<GraduationDesignDatumRecord> implements Record5<String, String, String, Integer, String> {

    private static final long serialVersionUID = 2092546826;
     ...
     */
    public GraduationDesignDatumRecord(String graduationDesignDatumId, String version, String fileId, Integer graduationDesignDatumTypeId, String graduationDesignReleaseId) {
        super(GraduationDesignDatum.GRADUATION_DESIGN_DATUM);
