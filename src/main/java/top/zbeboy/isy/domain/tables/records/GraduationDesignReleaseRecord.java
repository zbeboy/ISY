...
public class GraduationDesignReleaseRecord extends UpdatableRecordImpl<GraduationDesignReleaseRecord> implements Record13<String, String, Timestamp, String, Timestamp, Timestamp, Timestamp, Timestamp, Byte, String, Byte, Integer, Integer> {

    private static final long serialVersionUID = -232874177;
     ...
     */
    @Override
    public Row13<String, String, Timestamp, String, Timestamp, Timestamp, Timestamp, Timestamp, Byte, String, Byte, Integer, Integer> fieldsRow() {
     ...
     */
    @Override
    public Row13<String, String, Timestamp, String, Timestamp, Timestamp, Timestamp, Timestamp, Byte, String, Byte, Integer, Integer> valuesRow() {
     ...
     */
    @Override
    public GraduationDesignReleaseRecord values(String value1, String value2, Timestamp value3, String value4, Timestamp value5, Timestamp value6, Timestamp value7, Timestamp value8, Byte value9, String value10, Byte value11, Integer value12, Integer value13) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
