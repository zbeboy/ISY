...
public class GraduationDesignDeclareServiceImpl extends DataTablesPlugin<GraduationDesignDeclareBean> implements GraduationDesignDeclareService {
    ...
    private void buildData(Result<Record> records, List<GraduationDesignDeclareBean> graduationDesignDeclareBeens) {
    ...
    public List<GraduationDesignDeclareBean> findAllManifestByPage(DataTablesUtils<GraduationDesignDeclareBean> dataTablesUtils, GraduationDesignDeclareBean graduationDesignDeclareBean) {
        ...
        if (ObjectUtils.isEmpty(a)) {
            SelectJoinStep<Record> selectJoinStep = create.select()
                    ...
                    .leftJoin(DEFENSE_ORDER)
                    .on(DEFENSE_GROUP_MEMBER.DEFENSE_GROUP_ID.eq(DEFENSE_ORDER.DEFENSE_GROUP_ID))
                    .leftJoin(SCORE_TYPE)
