...
open class CacheBook {
    companion object {
        ...
        */
        ...
        const val GRADUATION_RANGE_GRADUATION_DATE_CONDITION = "GRADUATION_RANGE_GRADUATION_DATE_CONDITION_"

        const val GRADUATION_RANGE_GRADUATION_FILL_TEACHER_DATE_CONDITION = "GRADUATION_RANGE_GRADUATION_FILL_TEACHER_DATE_CONDITION_"

        const val GRADUATION_IS_OK_TEACHER_CONDITION = "GRADUATION_IS_OK_TEACHER_CONDITION_"

        const val GRADUATION_IS_OK_TEACHER_ADJUST_CONDITION = "GRADUATION_IS_OK_TEACHER_ADJUST_CONDITION_"
