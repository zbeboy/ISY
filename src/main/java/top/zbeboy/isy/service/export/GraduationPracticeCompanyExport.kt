 ...
 **/
class GraduationPracticeCompanyExport(data: List<GraduationPracticeCompany>) : ExportUtils<GraduationPracticeCompany>(data) {
    ...
    override fun createCell(row: Row, t: GraduationPracticeCompany) {
        sequence++
        ...
        row.createCell(10).setCellValue(t.graduationPracticeCompanyName)
        row.createCell(11).setCellValue(t.graduationPracticeCompanyAddress)
        row.createCell(12).setCellValue(t.graduationPracticeCompanyContacts)
        row.createCell(13).setCellValue(t.graduationPracticeCompanyTel)
