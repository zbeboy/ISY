 ...
 **/
class InternshipCompanyExport(data: List<InternshipCompany>) : ExportUtils<InternshipCompany>(data) {
    ...
    override fun createCell(row: Row, t: InternshipCompany) {
        sequence++
        ...
        row.createCell(10).setCellValue(t.internshipCompanyName)
        row.createCell(11).setCellValue(t.internshipCompanyAddress)
        row.createCell(12).setCellValue(t.internshipCompanyContacts)
        row.createCell(13).setCellValue(t.internshipCompanyTel)
