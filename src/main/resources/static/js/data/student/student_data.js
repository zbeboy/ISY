 ...
 */
require(["jquery", "handlebars", "lodash_plugin", "datatables.responsive", "check.all", "messenger"],
    function ($, Handlebars, DP) {
        ...
        */
        ...
        function cleanPassParam() {
            ...
            $(getPassParamId().science).val('');
            $(getPassParamId().grade).val('');
            $(getPassParamId().organize).val('');
        ...
        */
        ...
        function cleanWaitParam() {
            ...
            $(getWaitParamId().science).val('');
            $(getWaitParamId().grade).val('');
            $(getWaitParamId().organize).val('');
            $(getWaitParamId().studentNumber).val('');
