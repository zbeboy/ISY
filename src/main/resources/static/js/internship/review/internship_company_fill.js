 ...
 */
//# sourceURL=internship_company_fill.js
require(["jquery", "handlebars", "nav_active", "messenger", "jquery.address", "jquery.simple-pagination", "jquery.showLoading"],
    function ($, Handlebars, nav_active) {
        ...
        function init() {
            startLoading();
            initParam();
            $.post(web_path + ajax_url.company_fill_url, param, function (data) {
                endLoading();
        ...
        function nextPage(pageNumber) {
            ...
            startLoading();
            $.get(web_path + ajax_url.company_fill_url, param, function (data) {
                endLoading();
                listData(data);
            });
        }
