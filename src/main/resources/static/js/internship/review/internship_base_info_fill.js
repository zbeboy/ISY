...
require(["jquery", "handlebars", "nav_active", "messenger", "jquery.address", "jquery.simple-pagination", "jquery.showLoading"],
    function ($, Handlebars, nav_active) {
        ...
        */
        var webStorageKey = {
            STUDENT_NAME: 'INTERNSHIP_REVIEW_BASE_INFO_FILL_STUDENT_NAME_SEARCH',
            STUDENT_NUMBER: 'INTERNSHIP_REVIEW_BASE_INFO_FILL_STUDENT_NUMBER_SEARCH',
            SCIENCE_NAME: 'INTERNSHIP_REVIEW_BASE_INFO_FILL_SCIENCE_NUMBER_SEARCH',
            ORGANIZE_NAME: 'INTERNSHIP_REVIEW_BASE_INFO_FILL_ORGANIZE_NUMBER_SEARCH'
        };
