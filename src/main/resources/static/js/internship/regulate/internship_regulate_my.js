    ...
    function ($, Handlebars, nav_active) {
        ...
        */
        ...
        $('#export_xls').click(function () {
            ...
            window.location.href = encodeURI(web_path + getAjaxUrl().export_data_url + "?extra_search=" + searchParam + "&exportFile=" + JSON.stringify(exportFile) + "&internshipReleaseId=" + internshipReleaseId + '&staffId=' + init_page_param.staffId);
        });
