...
require(["jquery", "handlebars", "nav_active", "datatables.responsive", "jquery.address", "messenger"],
    function ($, Handlebars, nav_active) {
        ...
        */
        var webStorageKey = {
            STUDENT_NAME: 'INTERNSHIP_STATISTICS_SUBMITTED_STUDENT_NAME_SEARCH_' + init_page_param.internshipReleaseId,
            STUDENT_NUMBER: 'INTERNSHIP_STATISTICS_SUBMITTED_STUDENT_NUMBER_SEARCH_' + init_page_param.internshipReleaseId,
            SCIENCE_NAME: 'INTERNSHIP_STATISTICS_SUBMITTED_SCIENCE_NAME_SEARCH_' + init_page_param.internshipReleaseId,
            ORGANIZE_NAME: 'INTERNSHIP_STATISTICS_SUBMITTED_ORGANIZE_NAME_SEARCH_' + init_page_param.internshipReleaseId,
            INTERNSHIP_APPLY_STATE: 'INTERNSHIP_STATISTICS_SUBMITTED_INTERNSHIP_APPLY_STATE_SEARCH_' + init_page_param.internshipReleaseId
        };
