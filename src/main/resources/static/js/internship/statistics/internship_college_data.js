...
require(["jquery", "handlebars", "datatables.responsive", "dataTables.fixedHeader", "jquery.address", "messenger"],
    function ($, Handlebars) {
        ...
        var myTable = tableElement.DataTable({
            ...
            "ajax": {
                "url": web_path + getAjaxUrl().college_data_url,
                "dataSrc": "data",
                "data": function (d) {
                    // 添加额外的参数传给服务器
            ...
            "columns": [
                ...
                {"data": "internshipCollegeName"},
                {"data": "internshipCollegeAddress"},
                {"data": "internshipCollegeContacts"},
                {"data": "internshipCollegeTel"},
