...
require(["jquery", "nav_active", "datatables.responsive", "jquery.address", "messenger"],
    function ($, nav_active) {
       ...
       */
        ...
        function getAjaxUrl() {
            return {
                company_data_url: '/web/internship/statistical/company/data',
                export_data_url: '/web/internship/statistical/company/data/export',
        ...
        var myTable = tableElement.DataTable({
            ...
            "ajax": {
                "url": web_path + getAjaxUrl().company_data_url,
                "dataSrc": "data",
                "data": function (d) {
                    // 添加额外的参数传给服务器
                    initSearchContent();
            ...
            "columns": [
                ...
                {"data": "internshipCompanyName"},
                {"data": "internshipCompanyAddress"},
                {"data": "internshipCompanyContacts"},
                {"data": "internshipCompanyTel"},
