...
require(["jquery", "handlebars", "nav_active", "messenger", "bootstrap-maxlength",
    ...
    function ($, Handlebars, nav_active) {
        ...
        var param = {
            ...
            building: $(paramId.building).val(),
            schoolroomId: $(paramId.schoolroomId).val(),
            schoolroom: $(paramId.schoolroom).val(),
        ...
        function initParam() {
            ...
            param.building = $(paramId.building).val();
        ...
        var selectedSchoolroomCount = true;
        ...
        function selectedBuilding() {
            var realBuildingId = $(paramId.building).val();
            var buildingChildrens = $(paramId.buildingId).children();
        ...
        function changeSchoolroom(building_id) {
            if (Number(building_id) === 0) {
                ...
                $.post(web_path + ajax_url.schoolroom_data_url, {buildingId: building_id}, function (data) {
                    ...
                    if (selectedSchoolroomCount) {
                        selectedSchoolroom();
                        selectedSchoolroomCount = false;
                    }
                });
            }
        }
        ...
        function selectedSchoolroom() {
            var realSchoolroomId = $(paramId.schoolroom).val();
            var schoolroomChildrens = $(paramId.schoolroomId).children();
            for (var i = 0; i < schoolroomChildrens.length; i++) {
                if ($(schoolroomChildrens[i]).val() === realSchoolroomId) {
