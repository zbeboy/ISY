...
require(["jquery", "handlebars", "messenger", "jquery.address", "jquery.simple-pagination", "jquery.showLoading", "bootstrap"],
    function ($, Handlebars) {
         ...
         */
        var ajax_url = {
            release_data_url: '/web/graduate/design/archives/design/data',
       ...
       */
        var webStorageKey = {
            GRADUATION_DESIGN_TITLE: 'GRADUATE_DESIGN_ARCHIVES_TITLE_SEARCH'
        };
        ...
        */
        ...
        /*
         列表
         */
        $(tableData).delegate('.archive', "click", function () {
