...
require(["jquery", "requirejs-domready", "emails", "base64", "bootstrap", "csrf", "attribute_extensions", "bootstrap-typeahead", "bootstrap-notify"],
    function ($, domready, emails, base64) {
        domready(function () {
                    ...
                    $.post(web_path + ajax_url.login, $('#login_form').serialize(), function (data) {
                        ...
                        switch (data) {
                            ...
                            case error_code.OK_CODE:
                                ...
                                if (typeof(Storage) !== "undefined") {
                                    // Store
                                    localStorage.setItem(webStorageKey.LOGIN_USERNAME, base64.encode(email));
                                }
