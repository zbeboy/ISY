...
public abstract class AbstractIntegrationTests {
	...
	static {
		if (new ClassPathResource("214041306740340.pfx").exists()) {
			try {
				System.setProperty(JAVAX_NET_SSL_TRUST_STORE,
						new ClassPathResource("214041306740340.pfx").getFile().getAbsolutePath());
			} catch (IOException e) {
				throw new IllegalStateException(e);
			}
			System.setProperty(JAVAX_NET_SSL_TRUST_STORE_PASSWORD, "214041306740340");
		}
	}
